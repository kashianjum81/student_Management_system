...
@yield('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Muslim Town Wahdat Road
            <br>Pakistan</p>
        </div>
        <div class="col-md-4 mb-5 mb-lg-0">
        ...
        <div class="col-md-4">
          ...
          <p class="lead mb-0">Muhammad Kashif</p>
          <p>kashianjum81@gmail.com</p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; Muhammad kashif</small>
    </div>
  </div>
